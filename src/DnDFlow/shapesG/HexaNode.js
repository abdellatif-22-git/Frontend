...
const HexaNode = ({ id, data, selected }) => {
  ...
  return (
    <div style={{ position: "relative", display: "inline-block", zIndex: 1 }}>
      ...
      >
        <path
          d={`M ${size.width * 0.1} 0 L ${size.width * 0.9} 0 L ${size.width} ${
            size.height * 0.5
          } L ${size.width * 0.9} ${size.height} L ${size.width * 0.1} ${
            size.height
          } L 0 ${size.height * 0.5} Z`}
          fill={bgColor}
          stroke={borderColor}
