...
const CylinderNode = ({ id, data, selected }) => {
  ...
  const ellipseRadiusX = size.width / 2;
  const ellipseRadiusY = size.height / 6;
    ...
    <div style={{ position: "relative", display: "inline-block", zIndex: 1 }}>
      ...
      >
        ...
        <rect
          ...
          height={size.height - 2 * ellipseRadiusY}
          fill={bgColor}
          stroke={borderColor}
          strokeWidth={borderWidth}
        />
