...
const ClodeNode = ({ id, data, selected }) => {
  ...
  return (
    <div style={{ position: "relative", display: "inline-block", zIndex: 1 }}>
      ...
      <svg
        width={size.width}
        height={size.height}
        viewBox="1270 1680 140 80" 
        onClick={() => setIsEditing(!isEditing)}
        onDoubleClick={handleDoubleClick}
        style={{ cursor: "pointer", position: "relative" }}
      >
        <path
          d="M 1300 1697 C 1276 1697 1270 1717 1289.2 1721 C 1270 1729.8 1291.6 1749 1307.2 1741 C 1318 1757 1354 1757 1366 1741 C 1390 1741 1390 1725 1375 1717 C 1390 1701 1366 1685 1345 1693 C 1330 1681 1306 1681 1300 1697 Z"
          fill={bgColor}
          stroke={borderColor}
